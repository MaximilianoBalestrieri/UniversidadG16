...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-05-2024 a las 23:32:28
...
--
-- Base de datos: `universidadg16`
--
CREATE DATABASE IF NOT EXISTS `universidadg16` DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci;
USE `universidadg16`;
...
(1, 25123456, 'Balestrieri', 'Maximiliano', '1982-02-17', 1),
(2, 35222111, 'Ramos Molina', 'Nahir', '1990-11-04', 1),
(3, 41555666, 'Urquiza', 'Alan', '1988-10-10', 1);
